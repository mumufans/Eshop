package com.eshop.app.core.utils;
...
public class AuthenticationUtils {
    ...
    private final static String SALT = "eshopByJosephForPractice";
    ...
    public final static String generatePassword(final String password){
